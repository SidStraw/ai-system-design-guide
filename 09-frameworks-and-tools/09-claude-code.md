...
<a id="2-text_editor-file-operations"></a>
### 2. `text_editor` — 檔案操作
...
<a id="the-claudemd-manifest-pattern"></a>
## CLAUDE.md 清單模式
...
<a id="sub-agents-and-parallelism"></a>
## 子代理與平行化
...
<a id="safety-and-permission-model"></a>
## 安全與權限模型
...
<a id="production-use-ci-pipelines"></a>
## 正式環境用法：CI Pipeline
...
<a id="comparison-claude-code-vs-alternatives"></a>
...
<a id="q-what-is-claudemd-and-why-is-it-critical"></a>
